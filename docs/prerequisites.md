...
- **Kubernetes**: We recommend v1.33 or later (see [K8s releases](https://kubernetes.io/releases/)) with [kubectl](https://kubernetes.io/docs/reference/kubectl/) installed and configured.
  - No operator or AIS components require cluster versions newer than v1.28, but we do not test or guarantee support for EOL K8s releases.
