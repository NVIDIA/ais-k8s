...
const (
	DefaultNodeImage     = "docker.io/aistorage/aisnode:v4.6"
	DefaultInitImage     = "docker.io/aistorage/ais-init:v4.6"
	DefaultLogsImage     = "docker.io/aistorage/ais-logs:v1.1"
	DefaultPrevNodeImage = "docker.io/aistorage/aisnode:v4.5"
	DefaultPrevInitImage = "docker.io/aistorage/ais-init:v4.5"
