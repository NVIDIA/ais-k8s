...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AuthServerLoginConf) DeepCopyInto(out *AuthServerLoginConf) {
	*out = *in
	if in.Scope != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AuthServerLoginConf.
func (in *AuthServerLoginConf) DeepCopy() *AuthServerLoginConf {
	if in == nil {
		return nil
	}
	out := new(AuthServerLoginConf)
	in.DeepCopyInto(out)
	return out
}
