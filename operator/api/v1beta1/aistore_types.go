...
// GetScaleDownMode returns the effective scale-down mode, defaulting to decommission.
func (t TargetSpec) GetScaleDownMode() ScaleDownMode {
	if t.ScaleDownMode == nil {
		return ScaleDownModeDecommission
	}
	return *t.ScaleDownMode
}
